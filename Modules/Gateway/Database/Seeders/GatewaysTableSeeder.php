    ...
    public function run()
    {
        ...
        \DB::table('gateways')->insert(array(
            ...
            array(
                ...
                'name' => 'Razorpay',
                'sandbox' => 1,
                'data' => '{"apiKey":"rzp_test","apiSecret":"ABCDEFGHIJKLM123","instruction":"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.","status":"1","sandbox":"1"}',
                'instruction' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
                'image' => 'thumbnail.png',
                'status' => 1,
            ),
